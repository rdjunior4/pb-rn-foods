    ...
    return (
      <CustomerLayout maxWidth="1400">
        <div className="text-center py-24">
          <div className="inline-flex h-24 w-24 items-center justify-center rounded-3xl bg-gradient-to-br from-primary/10 to-primary/5 mb-8 ring-1 ring-primary/10">
  ...
  return (
    <CustomerLayout maxWidth="1400">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground text-sm mt-1">Gerencie seus dados e acompanhe seus pedidos</p>
      </div>

      <div className="rounded border border-border/40 bg-card shadow-card mb-8 overflow-hidden">
        <div className="bg-gradient-to-r from-red-800 via-red-700 to-red-600 px-6 sm:px-8 py-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-4">
              <div className="inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-white text-red-700 text-xl font-bold shadow-lg shrink-0">
                {initials}
              </div>
              <div>
                <h2 className="text-xl font-bold text-white drop-shadow-sm">{user!.name}</h2>
                <div className="flex flex-wrap items-center gap-2 mt-1">
                  ...
                  <span className="inline-flex items-center gap-1 rounded-full bg-white/90 text-red-600 px-2.5 py-0.5 text-[11px] font-semibold">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="inline-flex items-center gap-1.5 h-9 rounded border border-white text-red-600 bg-white text-xs font-semibold px-4 hover:bg-white/90 transition-colors"
              >
              ...
              <button
                onClick={logout}
                className="inline-flex items-center gap-1.5 h-9 rounded border border-black bg-black text-white text-xs font-semibold px-4 hover:bg-black/90 transition-colors"
              >
        ...
        <div className="px-6 sm:px-8 py-5 border-t border-red-100">
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6 text-sm text-muted-foreground">
            ...
            <span className="hidden sm:flex items-center gap-2">
              <DocIcon className="h-4 w-4 text-red-500" />
              {formattedDoc}
            </span>
            {user!.phone && (
              <span className="flex items-center gap-2">
